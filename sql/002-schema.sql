...
BEGIN
    ...
    (
        DexMeterId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_DEXMeter PRIMARY KEY DEFAULT NEWSEQUENTIALID(),
...
BEGIN
    ...
    (
        DexLaneMeterId UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_DEXLaneMeter PRIMARY KEY DEFAULT NEWSEQUENTIALID(),
...
BEGIN
    ...
    SET @DexMeterId = NEWSEQUENTIALID();
